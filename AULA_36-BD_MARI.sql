...
select *from  acoes where pl<25;
 ...
 select papel,cotacao,pl, pvp from acoes;
 select *from acoes where dividend_yield>=0.12;
 select papel,cotacao,pl,pvp,dividend_yield from acoes;
 select *from acoes where patrimonio_liquido>100000000000;
 select papel,cotacao,pl,pvp,dividend_yield, patrimonio_liquido from acoes;
 select *from acoes where pvp<=5 and pvp=0;
  ...
  select from acoes where patrimonio_liquido=5 
